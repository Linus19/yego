          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="footer_logo">
              <a href="index.php" class="mb-3 d-flex">
                <img src="./images/logo3.jpg" alt="" width="170px;">
              </a>
              <p>Murey Yego & Associates - We are constantly in pursuit of  excellence. To be the frontrunners in
                our field is a burning desire.

                Top end quality of our client deliverables is a commitment we have made to ourselves and we travel the
                extra mile to achieve it.
              </p>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
    ...
    <div class="container">
      <div class="copyright_row_wr">
        <div class="socials">
          <ul>
            <li>
              <a href="https://web.facebook.com/profile.php?id=100081922223527&ext=1728124734&hash=%2501%2501r%25E5%2582%25A4%25CD%25A8%258Et%259F%2560s%257E%25C5I%25D6P&_rdc=1&_rdr" target="_blank" class="social-facebook">
        ...
        <div class="copyright">
          &copy 2024 <a href="" target="_blank">
          Murey Yego & Associates CPA (K)-</a> Design by <a href="" target="_blank">likirotechnologies</a> </div>
      </div>
    </div>
  </div>
</footer>
...
<a id="scrollUp" href="#top" style="position: fixed; z-index: 2147483647; display: block;">
  ...
  <a href="https://api.whatsapp.com/send?phone=+254780851599&text=Hello." class="float" target="_blank">
  <img src="img/whatsapp.png" class="icon img-fluid" style="width: 50px; height: 50px;" alt="WhatsApp Icon"/>
</a>
